...
| `cks_event_schema_v1.yaml` | ACTIVE | Единый контракт событий запуска Worker без непрерывного опроса LLM. |
| `cks_evidence_schema_v1.yaml` | ACTIVE | Единый контракт формата доказательств действий Worker. |
